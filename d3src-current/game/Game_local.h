...
#ifdef MOD_BOTS // TinMan: Cobalts network wrapper
#include "../bots/BotNetwork.h"
#endif
...
public:
	...
	// cusTom3 - moved out of #if _D3XP above - was here even if not defined in game project
	bool					NeedRestart();
