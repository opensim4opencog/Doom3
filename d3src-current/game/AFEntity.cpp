...
void idGameEdit::AF_UndoChanges( void ) {
	...
	//when the .exe loads it has already finalized the creation of the idDict... the declManager is there so we can get at them.. but then when they started making the idGameEdit part of the SDK.. they started doing the exact same un consting as i am doing .. but but the main things are still in the .exe which i am not
