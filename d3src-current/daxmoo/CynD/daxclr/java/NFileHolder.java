...
public class NFileHolder {
     ...
     * @param file1 the <code>File</code> that needs the association.
     * @param object1 the <code>Object</code> that is to be associated with the <code>File</code>.
     */
    public NFileHolder(File file1, Object object1) {
        this.object = object1;
        this.file = file1;
