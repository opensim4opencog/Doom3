...
public class NClassLoader extends ClassLoader {
    ...
    NFS = (FS == '/' ? '\\' : '/');
    private String baseRoot = "c:/doom3/base/classes/." + FS;
    @SuppressWarnings("unused")
	private String jarRoot = "." + FS;


    private String extension = ".class";
    private static Hashtable<String, NFileHolder> classservlets = new Hashtable<String, NFileHolder>();
     ...
     */
    public NClassLoader(String strRepositoryPath, String strExtension,
                        String strJarDir) {
        super();
     ...
     * @throws <code>ClassNotFoundException</code>
     */
    public Class loadClass(String base, String name) throws
    ...
    public Class<?> findClass(String name) throws ClassNotFoundException {
        ...
        /*   if (!name.startsWith("daxclr.ext.") && !name.startsWith("daxclr.plugin.")) {
               return Class.forName(name);
           }*/
        ...
        try {
            ...
            NFileHolder nfh = classservlets.get(fullname);
        ...
        if (c == null) {
            ...
            classservlets.put(fullname, nfh);
    ...
    private void definePackage(String className) {
        ...
        String specTitle, specVersion, specVendor, implTitle, implVersion,
        implVendor;
        ...
        if (null != attr) {
            ...
            definePackage(pkgName, specTitle, specVersion, specVendor,
