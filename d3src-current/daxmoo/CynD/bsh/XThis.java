...
public class XThis extends This {
	...
	protected/* dmiles */InvocationHandler invocationHandler = new Handler();
	 ...
	 * 
	 * I don't understand this. JThis works just fine even if those classes aren't
	 * there (doesn't it?) This class shouldn't be loaded if an XThis isn't
	 * instantiated in NameSpace.java, should it?
	 */
	public /*dmiles*/ class Handler implements InvocationHandler, java.io.Serializable {
		...
		public Object invokeImpl(Object proxy, Method method, Object[] args) throws EvalError {
			 ...
			 * implemented by the This object protocol for scripted object. To support
			 * XThis equals() must test for equality with the generated proxy object,
			 * not the scripted bsh This object; otherwise callers from outside in
			 * Java will not see a the proxy object as equal to itself.
			 */
			...
			/*
			 * If toString() is not explicitly defined override the default to show
