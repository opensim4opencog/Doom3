 ...
 */
 public 	jPrologAPI(InputStream source,iPrologFileServices fs,
							PrintWriter output,
							BufferedReader input,
							aAnimationEnvironment ae) throws IOException
 {
  prolog = new jPrologServices(new jKnowledgeBase(),
                               new pPredicateRegistry(),
							   new pOperatorRegistry());
 ...
 */ 
  ...
  *
  * @param fp 		If <code>fail</code> (default) then missing predicates generate a 
  *					failing exception (i.e., exception thrown), if <code>false</code> 
  ...
  *
  * @return		The <code>jTermTranslation</code> object used for translating between 
  *				objects and terms.
  */
  ...
  * Java objects.
  *
  * @param tt		The <code>jTermTranslation</code> object to use for translating between 
  *					objects and terms.
  */
 ...
 * <code>jTermTranslation</code> for more information about how translation between
 ...
 *					null, then performs the same as <code>query(String)</code> above.
 * @return			Returns a hashtable of variable bindings (just like 
 *					<code>query(String)</code> above).  The values are translated using the
 ...
 * 
 * @return			Returns a hashtable of variable bindings (just like 
 *					<code>query(String)</code> above).  Returns null if the query retry fails.
 */
