...
import org.jatha.display.*;
import org.jatha.dynatype.*;
import org.jatha.compile.*;
import org.jatha.eval.*;
import org.jatha.machine.*;
import org.jatha.read.*;
import org.jatha.util.*;
...
public class Jatha extends Object implements ActionListener
{
  ...
  private int    VERSION_MINOR    = 7;
  private int    VERSION_MICRO    = 1;
  private String VERSION_TYPE     = "";
  private String VERSION_DATE     = "23 Feb 2006";
...
/* ------------------  NON-LISP methods   ------------------------------ */
  ...
  */
  ...
  {
    return new StandardLispCons(this, first, NIL);
  }

  public LispCons makeList(LispValue first, LispValue second)
  {
    return new StandardLispCons(this, first, new StandardLispCons(this, second, NIL));
  }

  public LispCons makeList(LispValue first, LispValue second, LispValue third)
  {
    return new StandardLispCons(this, first,
                        new StandardLispCons(this, second,
                                     new StandardLispCons(this, third, NIL)));
  }
                           ...
                           LispValue third, LispValue fourth)
  {
    return new StandardLispCons(this, first,
                        new StandardLispCons(this, second,
                                     new StandardLispCons(this, third,
                                                  new StandardLispCons(this, fourth, NIL))));
  }
  ...
  public LispValue toLisp(Object obj) // TODO: Is this where we use dynatype.LispForeignObject?
  {
    ...
    try
    {
      result = (new LispParser(this, obj.toString(), LispParser.PRESERVE)).parse();
    } catch (Exception e)
    {
