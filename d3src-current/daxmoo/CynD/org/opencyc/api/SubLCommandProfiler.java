/* $Id: SubLCommandProfiler.java,v 1.3 2005/12/22 23:32:30 jantos Exp $
 *
 ...
 * @version $Id: SubLCommandProfiler.java,v 1.3 2005/12/22 23:32:30 jantos Exp $
 */
public class SubLCommandProfiler implements SubLWorkerListener {
  ...
  public static void main(final String[] args) {
    ...
    try {
      final CycAccess access = new CycAccess("CycServer", BASE_PORT);
