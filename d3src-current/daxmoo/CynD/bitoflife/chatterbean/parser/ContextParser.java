...
public class ContextParser
{
  ...
  */
  ...
  private class ContextHandler extends DefaultHandler
  {
    ...
    {
      if (qname.equals("set"))
        context.setPredicate(attributes.getValue("name"), attributes.getValue("value"));
      else if (qname.equals("bot"))
        context.setBotPredicate(attributes.getValue("name"), attributes.getValue("value"));
    }
  }
  ...
  */
  ...
  public Context parse(Reader source) throws IOException, SAXException
  {
    context = new Context();
