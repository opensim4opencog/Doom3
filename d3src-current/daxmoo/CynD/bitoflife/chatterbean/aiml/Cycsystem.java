...
public class Cycsystem extends TemplateNodeTag {
    ...
    */
    ...
    public Cycsystem(Attributes attributes) {
        filter= attributes.getValue(0);
    }

    public Cycsystem(Object... children) {
        super(children);
    }
    ...
    */
    ...
    public String toString(Match match) {
        ...
        try {
            String cycResult;
            query=aimlresult;
            java.lang.System.out.println("CycSystem Aimlresult=["+aimlresult+"]");
            Object guessList =cycAccess.converseObject(query);

            if (filter!=null && filter.matches("paraphrase")) {
            bestResult=daxclr.inference.CycAPI.paraphrase (guessList);
            }
            else if (guessList instanceof CycList) {
