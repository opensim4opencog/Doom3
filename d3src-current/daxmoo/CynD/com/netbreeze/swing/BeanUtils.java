...
public class BeanUtils {
  ...
  public static void registerEditors() {
    ...
    PropertyEditorManager.setEditorSearchPath(new String[] {"com.netbreeze.swing.editors","sun.beans.infos","sun.beans.editors"});
  }

  public static void setBeanInfoSearchPath() {
    Introspector.setBeanInfoSearchPath(new String[] {"com.netbreeze.swing.editors","sun.beans.infos","sun.beans.editors"});
  }
}