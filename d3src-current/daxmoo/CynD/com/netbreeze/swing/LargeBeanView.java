 ...
 * including properties, methods, etc. <p>
 *
...
public class LargeBeanView extends BeanView implements Customizer {
  ...
  public Dimension getPreferredSize() {
    ...
    int w,h;
    w = Math.min(dim.width + 30, 350);
    h = Math.min(dim.height + 30, 500);*/
    return Utility.getConstrainedDimension(
      getMinimumSize(),
  ...
  /**
   * Delegates directly to setBean(...). This method is needed to
   * conform to the Customizer interface.
   */
