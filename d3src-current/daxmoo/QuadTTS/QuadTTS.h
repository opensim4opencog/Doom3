...
JNIEXPORT jboolean JNICALL Java_daxclr_ext_QuadmoreTTS_setVoiceToken(JNIEnv *env,jobject obj,jstring strVoiceToken)
{
...
JNIEXPORT jboolean JNICALL Java_daxclr_ext_QuadmoreTTS_SpeakDarling(JNIEnv *env,jobject obj,jstring strInput)
{
	/*
...
JNIEXPORT jstring JNICALL Java_daxclr_ext_QuadmoreTTS_getVoiceToken(JNIEnv *env, jobject obj)
{
